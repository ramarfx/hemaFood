                    ...
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="base">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="/kaiadmin/components/avatars.html">
                                            <span class="sub-item">Avatars</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/buttons.html">
                                            <span class="sub-item">Buttons</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/gridsystem.html">
                                            <span class="sub-item">Grid System</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/panels.html">
                                            <span class="sub-item">Panels</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/notifications.html">
                                            <span class="sub-item">Notifications</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/sweetalert.html">
                                            <span class="sub-item">Sweet Alert</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/font-awesome-icons.html">
                                            <span class="sub-item">Font Awesome Icons</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/simple-line-icons.html">
                                            <span class="sub-item">Simple Line Icons</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/kaiadmin/components/typography.html">
        ...
        <div class="main-panel">
            <div class="main-header">
                <div class="main-header-logo">
                    ...
                    <div class="logo-header" data-background-color="dark">
                        <a href="index.html" class="logo">
                            <img src="/kaiadmin/assets/img/kaiadmin/logo_light.svg" alt="navbar brand"
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="/kaiadmin/assets/img/jm_denis.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="/kaiadmin/assets/img/chadengle.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="/kaiadmin/assets/img/mlane.jpg" alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="/kaiadmin/assets/img/talha.jpg" alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="/kaiadmin/assets/img/profile2.jpg"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/id.png"
                                                                        alt="indonesia" />
                                                                </div>
                                                            </td>
                                                            <td>Indonesia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/us.png"
                                                                        alt="united states" />
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/au.png"
                                                                        alt="australia" />
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/ru.png"
                                                                        alt="russia" />
                                                                </div>
                                                            </td>
                                                            <td>Russia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/cn.png"
                                                                        alt="china" />
                                                                </div>
                                                            </td>
                                                            <td>China</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="/kaiadmin/assets/img/flags/br.png"
                                                                        alt="brazil" />
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                            ...
                            <div class="card card-round">
                                <div class="card-body">
                                    ...
                                    <div class="card-list py-4">
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/kaiadmin/assets/img/jm_denis.jpg" alt="..."
                                                    class="avatar-img rounded-circle" />
                                            </div>
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/kaiadmin/assets/img/talha.jpg" alt="..."
                                                    class="avatar-img rounded-circle" />
                                            </div>
                                            <div class="info-user ms-3">
                                        ...
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img src="/kaiadmin/assets/img/chadengle.jpg" alt="..."
                                                    class="avatar-img rounded-circle" />
                                            </div>
                                            <div class="info-user ms-3">
